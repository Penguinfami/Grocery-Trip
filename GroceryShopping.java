...
public class GroceryShopping extends Minigame {
  ...
  public GroceryShopping(int screenWidth,int screenHeight, int shopScreenWidth, int shopScreenHeight,String day, int difficulty){
    ...
    this.map = new TileMap("map.txt", shopScreenWidth, shopScreenHeight, 2, 2);
  ...
  public void createFoodProducts(){
    try{
      BufferedReader reader = new BufferedReader(new FileReader ("foodProducts.txt"));
      String line;
      String name;
    ...
    try{
      BufferedReader reader = new BufferedReader(new FileReader ("meals.txt"));
      String line;
      int index = 0;
