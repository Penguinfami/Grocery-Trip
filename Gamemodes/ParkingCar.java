...
import Components.ParkingSpace;
...
public class ParkingCar extends Minigame {
  ...
  public ParkingCar(int width, int height, int difficulty){
    ...
    this.map = new TileMap("Info/parkingLot.txt",  width * 19/20, height, 1, 1 );// create the parking lot
